      ...
      <div className="forget">
        <div className="container">
          <div className="forget-div">
            <img src={forget} alt="forget" className="animate__animated animate__fadeInLeftBig wow" data-wow-offset="200"/>
            <div className="forget-div-text animate__animated animate__fadeInRightBig wow" data-wow-offset="200">
